...
def matrix(data, classe = ''):
    ...
    cmap = 'RdYlGn'
    mask = np.triu(np.ones_like(data[colonnes].corr(), dtype=bool))
    sns.heatmap(data[colonnes].corr(), mask=mask, annot=True, cmap=cmap, vmin=0, vmax=1, center=0.5,
